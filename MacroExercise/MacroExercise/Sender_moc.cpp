...
static const char qt_meta_stringdata_Sender[] = {
    "Sender\0\0,\0dataReady(QString,bool)\0"
    "internalWorker()\0"
};
...
void Sender::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->dataReady((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        case 1: _t->internalWorker(); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void Sender::dataReady(const QString & _t1, bool _t2)
{
