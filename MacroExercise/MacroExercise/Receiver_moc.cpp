...
static const char qt_meta_stringdata_Receiver[] = {
    "Receiver\0\0killApp()\0doWork()\0,\0"
    "doMoreWork(QString,bool)\0"
};
...
void Receiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->killApp(); break;
        case 1: _t->doWork(); break;
        case 2: _t->doMoreWork((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        default: ;
        }
    }
}
